...
const Resume = () => {
  ...
  useEffect(()=>{
      const loadResume = async () => {
        const resume = await kv.get(`analysis-${id}`);
        if(!resume) return;
  ...
  return (
    <main className='!pt-0'>
      ...
      <div className='flex flex-row w-full max-lg:flex-col-reverse'>
        <section className="feedback-section bg-[url('/images/bg-small.svg')] bg-cover h-[100vh] sticky top-0 items-center justify-center overflow-hidden">
          {imageUrl && resumeUrl && (
